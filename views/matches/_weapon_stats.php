...
<table class="table">
	...
	<tr>
		...
		<?php foreach($weapons as $weapon): ?>
			<td style="border-left: 1px solid #DDDDDD; text-align: center; min-width: 50px;"
			    colspan="2"><?= Html::img(Yii::$app->urlManager->createAbsoluteUrl("/images/kills/csgo/" . $weapon . ".png"), array(
					"class" => "needTips_S", "title" => $weapon,
				)); ?></td>
		<?php endforeach; ?>
	</tr>
	<tr>
	...
	<?php foreach($match->currentMap->getPlayers()->orderBy('team')->all() as $player): ?>
		...
		<tr>
			<td style="width: 150px; min-width: 150px;"><a
