...
<table class="table table-striped table-condensed" id="tablePlayers">
	...
	<tr>
		...
		<th><?= Yii::t('app', "1v4"); ?></th>
		<th><?= Yii::t('app', "1v5"); ?></th>
		<th style="border-left: 1px solid #DDDDDD;" class="needTips_S"
		    title="1 kill / round"><?= Yii::t('app', "1K"); ?></th>
		...
		<th style="border-left: 1px solid #DDDDDD;" class="needTips_S"
		    title="First Kill"><?= Yii::t('app', "FK"); ?></th>
	...
	<?php foreach($match->currentMap->players as $player): ?>
		...
		<tr>
			...
			<td>
				<a href="<? //php echo url_for("player_stats", array("id" => $player->getSteamid())); ?>"><?php echo $player->pseudo; ?></a>
			</td>
			<td <?php if($player->nb_kill == 0) echo 'class="muted" '; ?>
					style="border-left: 1px solid #DDDDDD;"><?php echo $player->nb_kill; ?></td>
			...
			<td <?php if($player->defuse == 0) echo 'class="muted" '; ?>
					style="border-left: 1px solid #DDDDDD;"><?php echo $player->defuse; ?></td>
			...
			<td <?php if($player->nb1 == 0) echo 'class="muted" '; ?>
					style="border-left: 1px solid #DDDDDD;"><?php echo $player->nb1; ?></td>
			...
			<td <?php if($player->nb1kill == 0) echo 'class="muted" '; ?>
					style="border-left: 1px solid #DDDDDD;"><?php echo $player->nb1kill; ?></td>
			...
			<td <?php if($player->firstkill == 0) echo 'class="muted" '; ?>
					style="border-left: 1px solid #DDDDDD;"><?php echo $player->firstkill; ?></td>
