...
<div class="form">
	...
	<?php $form = ActiveForm::begin(); ?>
		...
		<div class="row">
			...
			<div class="col-md-8">
				<?= $form->field($model, 'maps')->widget(SelectizeDropDownList::className(), ['items' => $model->getMaps(), 'options' => ['multiple' => true], 'clientOptions' => ['maxItems' => $model->map_selection_mode]]) ?>
			</div>
		</div>
		<div class="row">
			<div class="col-md-4">
