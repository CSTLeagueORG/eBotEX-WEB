...
{
return [
[['id', 'match_id', 'map_id', 'nb_kill', 'assist', 'death', 'point', 'hs', 'defuse', 'bombe', 'tk', 'nb1', 'nb2', 'nb3', 'nb4', 'nb5', 'nb1kill', 'nb2kill', 'nb3kill', 'nb4kill', 'nb5kill', 'pluskill', 'firstkill'], 'integer'],
            [['player_key', 'team', 'ip', 'steamid', 'first_side', 'current_side', 'pseudo', 'created_at', 'updated_at'], 'safe'],
];
}
