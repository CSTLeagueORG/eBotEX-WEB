	...
	class PlayerKill extends \yii\db\ActiveRecord {
		...
		public function rules () {
			return [
				...
				[
					['killed_id'], 'exist', 'skipOnError'     => true, 'targetClass' => Players::className(),
					                        'targetAttribute' => ['killed_id' => 'id'],
				],
				[
					['killer_id'], 'exist', 'skipOnError'     => true, 'targetClass' => Players::className(),
					                        'targetAttribute' => ['killer_id' => 'id'],
				],
				[
