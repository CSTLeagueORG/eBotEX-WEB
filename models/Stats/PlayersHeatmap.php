...
class PlayersHeatmap extends \yii\db\ActiveRecord {
	...
	public function rules () {
		return [
			...
			[['attacker_id'], 'exist', 'skipOnError'     => true, 'targetClass' => Players::className(),
			                           'targetAttribute' => ['attacker_id' => 'id'],
			],
			[['map_id'], 'exist', 'skipOnError'     => true, 'targetClass' => Maps::className(),
			                      'targetAttribute' => ['map_id' => 'id'],
			],
			[['match_id'], 'exist', 'skipOnError'     => true, 'targetClass' => Matchs::className(),
			                        'targetAttribute' => ['match_id' => 'id'],
			],
			[['player_id'], 'exist', 'skipOnError'     => true, 'targetClass' => Players::className(),
